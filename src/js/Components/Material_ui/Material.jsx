  ...
  return (
    <Paper className={classes.root}>
      ...
      <Autocomplete
        ...
        style={{ width: 300 }}
        onChange={useCallback((event, newVal) => {
          console.log(event, newVal);
        }, [])}
        renderInput={(params) => (
          <TextField {...params} label="Combo BOOOOX" variant="outlined" />
        )}
      />
      <hr />
      <Grid container spacing={2}>
        <Grid item>
          <CustomeButton color="red" />
        </Grid>
        <Grid item>
          <CustomeButton color="blue" />
        </Grid>
      </Grid>
      <hr />
      <KeyboardDatePicker
        ...
        // format="yyyy/MM/dd"
        margin="normal"
        id="date-picker-persian"
        label="Persian datepicker"
        value={selectedDate}
